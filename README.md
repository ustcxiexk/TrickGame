...
3）http://101.132.42.42:8888/login 在此界面，输入用户名和密码，用户名分别有（1，2,3,4），对应的密码为（1,2,3,4），玩家可酌情选择输入。注意：直到登录的用户数达到设定数目时才会进入游戏，否则会提示并等待在登录区。    
4）http://101.132.42.42:8888/play 进入游戏界面，开始进行游戏，页面如下：
